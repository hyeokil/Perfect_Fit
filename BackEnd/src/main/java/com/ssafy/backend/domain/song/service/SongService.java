...
public interface SongService {
    ...
    // 인기차트100 조회
    List<SongPopularChartDto> getPopular100Songs(Long memberId);

    // 최신차트100 조회
    List<SongPopularChartDto> getLatest100Songs(Long memberId);

    // 장르차트100 조회
    List<SongPopularChartDto> getGenre100Songs(Long memberId, String genre);
